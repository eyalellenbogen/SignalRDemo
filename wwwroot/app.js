...
var canvas, ctx, isDrawing, color, oldPosition, thickness = 20, maxThickness = 40, minThickness = 2;
...
function draw(ev) {
    ...
    var currentPosition = { x: pointer.clientX, y: pointer.clientY };
...
function setColor() {
    ...
    document.querySelector('.controls .brush .dot').style.backgroundColor = color;
}
function setThickness(thicker) {
    ...
    var dot = document.querySelector('.controls .brush .dot');
